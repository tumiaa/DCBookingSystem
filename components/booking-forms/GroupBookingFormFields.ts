...
// const PersonalInfoFormItems: (FormQuestion<GroupBookingFormData> | FormQuestionPair<GroupBookingFormData>)[] = [
//     [{
//           id: 'firstName',
//           label: 'First name:',
//           type: 'input',
...
//     const OrgInfoFormItems: (FormQuestion<GroupBookingFormData> | FormQuestionPair<GroupBookingFormData>)[] = [
//       {
//         id: 'schoolName',
//         label: 'School name:',
//         type: 'input',
...
//         type: 'select',
//         maxWidth:100,
//         options:{defaultValue:'NSW', values:[{value:'NSW', displayValue:'NSW'}]},
//         required: true
//       },{
//         id: 'addressCountry',
//         label: 'Country:',
//         type: 'combobox',
//         options: {defaultValue:'Australia', values:getCountries().map((c)=>({value:c, displayValue:c}))},
//         required: true
//       }, ],
//     ]

//     const ExtraInfoFormItems :(FormQuestion<GroupBookingFormData> | FormQuestionPair<GroupBookingFormData>)[]= [
//        {
//         id: 'howDidYouHear',
...
//         required: false
//       },
//       {id:'sendMarketingEmail', label:'Would you like to hear about ANSTO?', required:true, type:'toggle'},
//       //  {
//       //   id: 'notes',
...
const groupBookingFields: Record<keyof GroupBookingFormData, FormQuestion<GroupBookingFormData>> = {
  firstName: {
    id: 'firstName',
    label: 'First name:',
    type: 'input',
  ...
  addressCountry: {
    ...
    options: {
      ...
      values: getCountries().map((c) => ({ value: c, displayValue: c }))
    },
    required: true
  },
  howDidYouHear: {
...
const groupBookingSubformFields: SubformFields =
  // Record<
  //   keyof GroupBookingSubformDataItem,
...
const groupBookingDefaults: { form: GroupBookingFormData; subform: GroupBookingSubformDataItem } = {
  form: {
    firstName: '',
    lastName: '',
    addressCity: '',
...
// const groupBookingDefaults: GroupBookingFormData = {
//   firstName: '',
//   lastName: '',
//   addressCity: '',
//   addressCountry: '',
...
// }
export {
  // OrgInfoFormItems,PersonalInfoFormItems,ExtraInfoFormItems
